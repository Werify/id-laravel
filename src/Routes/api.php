...
Route::group(['prefix' => config('werify-auth-service.routes.group')], function () {
	...
	Route::post(config('werify-auth-service.routes.qr'), [config('werify-auth-service.controllers.AuthController.class'), config('werify-auth-service.controllers.AuthController.qr')]);
});
